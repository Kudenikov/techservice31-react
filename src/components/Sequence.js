        ...
        <div className="sequence__container">
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">1</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Оставьте заявку.</span>
              <ul className="list">
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">2</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Выезд нашего специалиста на&nbsp;объект.</span>
              <p className="sequence__container-description">Предварительная оценка газификации объекта с&nbsp;возможной 
                  консультацией по&nbsp;выбору газопотребляющего оборудования, устройств загазованности, системы водоподготовки.</p>
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">3</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Оформление договора на&nbsp;предоставление услуг.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">4</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Получение технических условий.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">5</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Проект газоснабжения объекта.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">6</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Земельные работы.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">7</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Монтаж газопровода.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">8</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Договор на сервисное обслуживание котла.</span>
              <p className="sequence__container-description">Дополнительная услуга. Выполняется специалистами ООО &laquo;Техсервис&raquo; 
                  или сторонней организацией по&nbsp;решению заказчика.</p> 
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">9</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Договор о&nbsp;техническом обслуживании и&nbsp;ремонте ВДГО.</span>
              <p className="sequence__container-description">Выполняется специалистами ООО &laquo;Газпром газораспределение&raquo;.</p> 
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">10</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Договор на&nbsp;поставку газа.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">11</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Акт проверки технического состояния дымоходов.</span>
              <p className="sequence__container-description">Дополнительная услуга. Выполняется специалистами ООО &laquo;Техсервис&raquo; 
                  или сторонней организацией по&nbsp;решению заказчика.</p> 
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">12</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Строительная готовность.</span>
          ...
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">13</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Инспекция технического надзора.</span>
              <p className="sequence__container-description">Выполняется специалистами ООО &laquo;Газпром газораспределение&raquo;.</p> 
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">14</div>
              <div className="sequence__container-line"></div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Техническое присоединение.</span>
              <p className="sequence__container-description">Выполняется специалистами ООО &laquo;Газпром газораспределение&raquo;. 
                  Срок выполнения 8&nbsp;месяцев с&nbsp;даты подписания договора поставки газа.</p> 
            </div>
          </div>
          <div className="sequence__container-horizontal-item">
            <div className="sequence__container-pic">
              <div className="sequence__container-round">15</div>
            </div>
            <div className="sequence__container-text">
              <span className="sequence__container-title">Пуск газа.</span>
              <p className="sequence__container-description">Выполняется специалистами ООО &laquo;Газпром газораспределение&raquo;.</p> 
            </div>
          </div>
        </div>
